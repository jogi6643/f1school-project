...
function goBack() {
  ...
  <?php 
    ...
    $ids = $row->planid."_".$row->schoolid."_".$row->year;
  ...
  ?>
    ...
    <td>{{$row->year}}</td>
     ...
     <td><a class="btn btn-info" href="{{ url('avaiable-student-according-to-School-plan'.'/'.base64_encode($ids)) }}">{{$row->student_count}}</a></td>  
