...
<div class="col-md-8">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><button type="button" class="btn btn-primary" onclick="addtocard('{{$itemid_studentid}}','{{$carbody1->applicationid}}',1)">Add to Cart</td>
   ...
   ?>
      ...
      <td><button type="button" class="btn btn-primary" onclick="addtocard('{{$itemid_studentid}}','{{$carbodypart1->applicationid}}',2)">Add to Cart</button></td>
...
<script>
    //  var i=1;
   function addtocard(itemid_studentid,applicatiionid,body)
   {
      
 alert(itemid_studentid+applicatiionid+body);

      $.ajax({
						url:"{{url('addcart')}}/"+itemid_studentid+"/"+body,
