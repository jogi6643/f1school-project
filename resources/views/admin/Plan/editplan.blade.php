...
function goBack() {
  ...
  <form class="form-horizontal" method="post" action="{{url('editplan')}}/{{Route::Input('editplan')}}" enctype="multipart/form-data">
...
<div class="form-group">
    ...
    <div class="col-sm-8"> 
    <input type="text"  required value="{{$plan->name}}" class="form-control" name="name" id="pwd" placeholder="Enter Plan Name">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="team">Manufacturing Cost</label>
    <div class="col-sm-8"> 
    <input type="number" required value="{{$plan->manufacturing_cost}}" class="form-control" name="manufacturing_cost" id="pwd" placeholder="Manufacturing Cost">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-8"> 
	 ...
	 <option value="" >--Select block level --</option>
	  <option value="1" @if($plan->level==1) selected @endif>Individual</option>
	  <option value="2" @if($plan->level==2) selected @endif>Team</option>
	 </select>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-8"> 
    <input type="number" required value="{{$plan->number}}" class="form-control" min=1 name="number" id="pwd" placeholder="Number of block">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="team">Block Price</label>
    <div class="col-sm-8"> 
    <input type="number" required value="{{$plan->block_price}}" class="form-control" min=1 name="block_price" id="pwd" placeholder="Number of block">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-4" for="team">Status</label>
    <div class="col-sm-8"> 
