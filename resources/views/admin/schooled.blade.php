...
@endif
   ...
   <div class="col-md-10 offset-md-1">
         <form method="post" action="{{url('schooled')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
             ...
             @endif
               ...
               <div class="form-group">
             <input type="file" name="pimage" class="form-control" value="{{$r->pimage}}">
             </div>
         ...
         <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="email" name="email" id="email" class="form-control" value="{{old('email')?old('email'):$r->email}}">
