...
<?php $count=count($student->toArray());?>
  <!-- <din class="row"> -->
   
  <form class="form-horizontal" method="post" action="{{url('teamupdatebyad')}}" enctype="multipart/form-data">
...
<div class="col-md-7">
  ...
  <div class="form-group"> 
   <label class="control-label col-sm-12" for="des">Description</label>
    <div class="col-sm-10"> 
       <textarea class="form-control" value="{{$edit->team_Description}}" name="about_team" placeholder="Describe here..." rows="5" id="comment"> {{$edit->team_Description}}</textarea>
    </div>
  </div>
        ...
        <thead class="thead-dark">
          ...
          @else
           <tr id="xyz{{$student1->studentid}}">
            ...
            <td><span onclick='cancel(this,{{$student1->studentid}})'>X</span></td>
          </tr>
          @endif
          @endforeach
           @else
