      ...
      <div class="col-md-12">
        ...
        <div class="cards">
          <div class="cards_title">
            <span><img src="{{url('assets1/img/update-ico.png')}}" width="100%"></span>{{$video->title}}</span>
          </div>
          <div class="course_attempt">
         ...
         <!--      <iframe class="embed-responsive-item" src="{{ $video->video_path }}" allowfullscreen></iframe> -->
           ...
           data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "{{ $video->video_path }}"}] }'
           >
          <button onclick="_vplayer.play()">play</button>
          <button onclick="_vplayer.requestFullscreen()">fullscreen</button> 
          </video>
            <!-- </div> -->
