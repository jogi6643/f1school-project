         ...
         <form method="post" action="{{url('editbyadd')}}" enctype="multipart/form-data">
           ...
           <div class="form-group">
              ...
              <div class="form-group" >
               ...
               <input disabled="" id="email"  required type="text" name="studentemail" value="{{$student->studentemail}}" class="form-control">
                <input hidden="hidden" id="email"  required type="text" name="studentemail" value="{{$student->studentemail}}" class="form-control">
