  ...
  <div class="col-md-6">
     ...
     <div class="mt-5 ">
      @if($errors->any())
       ...
       @endif
       <form method="post" action="{{url('verify-OTP-Username-Post')}}"/>
         @csrf
        
        <div hidden="" class="form-group">
          <label for="pwd" class="textlable"><strong>Mobile Number:</strong></label>
          <input type="Number" name="mobile_no" value={{$mobile_no}} class="form-control">
        </div>
        <div hidden="" class="form-group">
          <label for="pwd" class="textlable"><strong>DOB::</strong></label>
          <input type="date" name="dob" class="form-control" value="{{$dob}}" id="pwd2">
        </div>
         <div class="form-group">
          <label for="pwd" class="textlable"><strong>Enter OTP</strong></label>
          <input type="text" name="otp" class="form-control" id="pwd2">
        </div>
        <div class="form-group">
