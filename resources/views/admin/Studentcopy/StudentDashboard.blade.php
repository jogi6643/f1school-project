  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-8 col-md-9 col-lg-9">
        ...
        <p class="last">Last Login: {{date('d F, Y | h:i:a',$date)}}</p>
      ...
      <div class="col-md-8">
        ...
        <div class="owl-carousel owl-theme cards_courses">
         <div class="item">
            <div class="grid_holder">
                <div class="mini_cards_content">
                  <h3 class="title">No Course Assign Yet.</h3>
                </div>
              </div>
          </div>
          </div>
        ...
        <div class="cards">
          ...
          <div class="cards_design">
            ...
            <div class="col-md-4 col-lg-3">
            <div class="design_details">
              No Team Assign For Manufacture Design.
            </div>
          </div>
            </div>
            @endif
        ...
        <div class="cards">
          <div class="cards_title">
            ...
            <a href="{{url('orderList')}}/{{base64_encode($ids1)}}"><span class="cards_title_redirect"><img src="{{url('assets1/img/redirect.png')}}" width="100%"></span></a>
            @endif
          </div>
           @if(count($order)>0)
