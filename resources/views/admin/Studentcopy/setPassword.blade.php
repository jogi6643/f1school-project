...
<body oncontextmenu="return false;"  style="background-image: url('public/admin/img/canva.jpg'); background-size: cover; background-position: bottom;">
<div class="container">
       ...
       <form method="post" action="{{url('reset-Password')}}"/>
        ...
        <div hidden="" class="form-group">
         ...
         <div class="form-group">
          ...
          <input type="text" name="Password" class="form-control" id="pwd2">
        </div>
         <div class="form-group">
          <label for="pwd" class="textlable"><strong>Confirm Password</strong></label>
          <input type="text" name="rePassword" class="form-control" id="pwd2">
        </div>
        <div class="form-group">
