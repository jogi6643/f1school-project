        ...
        <div class="cards">
          ...
          <div class="course">
            ...
            <p>{{$courseinfo1->description}}</p>
             ...
             <div class="detail"><span>Activation Date</span> Date Not Assigned  &nbsp;&nbsp;&nbsp;<span>Format</span> {{$courseinfo1->type}} &nbsp;&nbsp;&nbsp;<span>Duration</span> 12min</div>
             @else 
             <?php
            $var = $d;
            ...
            ?>
             <div class="detail"><span>Activation Date</span> {{date('d F,Y',strtotime($date1))}} &nbsp;&nbsp;&nbsp;<span>Format</span> {{$courseinfo1->type}} &nbsp;&nbsp;&nbsp;
