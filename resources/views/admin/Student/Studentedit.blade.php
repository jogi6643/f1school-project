 ...
 @section('content')
  ...
  <link rel="stylesheet" href="public/resources/demos/style.css"> -->
            ...
            @endif
       <div class="col-md-12">
         <form method="post" action="{{url('editbyadd')}}" enctype="multipart/form-data">
            @csrf
           ...
           <div class="form-group">
              ...
              <div class="form-group" >
               <label>Email</label>
               <input  id="email" type="text" name="studentemail" value="{{$student->studentemail}}" class="form-control">
           ...
           <!-- <span style="color:red;font-size:20px"class="required">*</span> -->
               <div class="form-group">
               <label>Student Date of Birth<span style="color:red;font-size:20px"class="required">*</span></label>
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
 ...
 $('#datepicker').datepicker({minDate: new Date(2000,1-1,1), maxDate: '-9Y',
      dateFormat: 'dd/mm/yy',
      changeMonth: true,
      changeYear: true,
      yearRange: '-110:-9'});
