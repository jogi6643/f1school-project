...
<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-4">
        <form class="form-signin" method="POST" action="{{ url('new_user_reg') }}">
        @csrf
        ...
        <input type="Number" id="inputMobile" class="form-control" name="mobileno" placeholder="8700488718" required autofocus>
        <br>
        <label for="inputDate" class="sr-only">DOB</label>
        <input type="date" id="inputPassword" class="form-control"  placeholder="" name="dob" required>
        ...
        <div class="checkbox mb-3 ">
          <label>
            <a href="{{url('studentemailfpassword')}}" class="text-color">Forgot Password</a>
          </label>
        </div>
