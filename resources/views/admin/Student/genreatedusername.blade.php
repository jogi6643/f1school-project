...
@media only screen and (min-width: 992px) {
  ...
  <body style="background-image: url('admin/img/canva.jpg'); background-size: cover; background-position: bottom;">
    ...
    <div class="form-group">
      ...
      <input type="password" id="psw"  pattern=".{8,}" title="Password Should have atleast 8 characters" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"  placeholder="Create Password" name="password" required>
	...
	<div id="message">
		  ...
		  <p  class="text-danger"  style="margin-bottom:0px !important;" id="length" class="invalid">Password Should have atleast<b> 8 characters</b></p>
		</div>
