         ...
         <form method="post" action="{{url('store')}}" enctype="multipart/form-data">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input id="email"   type="text" name="studentemail" value="{{old('studentemail')}}" class="form-control">
         ...
         <!--    <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input  id="mobile" type="text" value="{{old('mobileno')}}"    name="mobileno" class="form-control">
