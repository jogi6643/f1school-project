...
<div class="container">
  ...
  <form class="form-horizontal" method="post" action="{{url('teamstorebytr')}}" enctype="multipart/form-data">
  ...
  <div class="card mb-3">
    <div class="card-header">Create Team By {{$trainername}}</div>
  <div class="row">
<div class="col-md-7">
  <div class="card-body">
    ...
    <div class="col-sm-10">
      <input type="text" value="{{$tid}}" class="form-control" name="student_id" id="student_id" placeholder="student_id">
    </div>
  </div>
  ...
  <div class="form-group">
   ...
   <label class="control-label col-sm-12" for="des">Description</label>
    <div class="col-sm-10"> 
       <textarea class="form-control" name="about_team"  rows="5" placeholder="Describe here..." id="comment"></textarea>
    </div>
  </div>
  ...
  <div class="form-group"> 
   <div class="row">
    ...
    <div class="col-sm-6"> 
     <button type="button" onclick="searchstudent1()"  class="btn btn-danger" id='searchstudent'>Search</button>
    </div>
   </div>
