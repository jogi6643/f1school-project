 ...
 @section('content')
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
            ...
            @endif
       <div class="col-md-12">
         <form method="post" action="{{url('studentupdatebyschool')}}" enctype="multipart/form-data">
            @csrf
           
            
             <div class="form-group">
             @if($student->pimage==null)
             <img style="border-radius: 50%" src="{{ URL::to('/') }}/ImageSchool/schoolimage.png" alt="placeholderpdf" width="100" height="100">
             @else
              <img style="border-radius: 50%" src="{{ URL::to('/') }}/ImageSchool/{{$student->pimage}}" alt="placeholderpdf" width="100" height="100">
             @endif
              </div>
               <div class="form-group">
             <input type="file" name="pimage" class="form-control" value="{{$student->pimage}}">
             </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input id="email" readonly="" required type="text" name="studentemail" value="{{$student->studentemail}}" class="form-control">
