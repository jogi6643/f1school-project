...
<html lang="en">
  <head>
    ...
    <title>F1 in Schools India - Participant1</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-muted">
              {{ ($studentName->school_name)=='' ? '':$studentName->school_name  }} <br>
          </p>
          <div class="row">
				<!-- <a href="{{url('studentprofile')}}/{{base64_encode($studentid)}}" style="color: #fff;">My Profile</a> -->

        <a href="{{url('courseList')}}" style="color: #fff;">Course List</a>
			</div>
			<div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          ?>
            <li>  
             ...
             <a class="text-white" href="{{url('student/competition')}}/{{base64_encode($studentid.'_'.$schoolid)}}">Competition 
              </a> 
              @endif
            ...
            <li hidden="">
                <a class="text-white" href="{{url('placeorderList/')}}/{{base64_encode($studentid.'.'.$schoolid)}}">
                    Place Order
                </a>
            </li>
			@if(session('studenteamroleId')==0)
            <li>
                <a class="text-white" href="{{url('createTeam/')}}/{{base64_encode($studentid.'_'.$schoolid)}}">
                  Create Team 
                </a>
              </li>
            ...
            @endif
			 ...
			 @if(session('studenteamroleId')!=0)
            <li>
     <a class="text-white"  href="{{url('viewTeam/')}}/{{base64_encode($studentid.'_'.$schoolid)}}">
                  View Team 
                </a>
           </li>

            <li>
           <a class="text-white" href="{{url('orderList/')}}/{{base64_encode($studentid.'_'.$schoolid)}}">
                  Order List
                </a>
            </li>
		   @endif
      @if(session('studenteamroleId')!=0)
              <li>
              <a   class="text-white" href="{{url('manufacturePage/')}}/{{base64_encode($studentid.'.'.$schoolid)}}">
 ...
 @if(session('compId')!=0)	   
			<li>
                <a class="text-white" href="{{url('add_sponsership')}}/{{base64_encode($studentid.'_'.$schoolid)}}">Add Sponsorship</a>
              </li>
      @endif      
          <li>
  ...
  <div class="navbar navbar-dark shadow-sm" style="background-color:#d70a01; ">
    <div class="container d-flex justify-content-between">
      <a href="{{url('dashboard')}}" class="navbar-brand d-flex align-items-center" padding="top:10px;">
