...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{url('assets1/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{url('assets1/css/cover.css')}}">

    <!-- Owl Stylesheets -->
    <link rel="stylesheet" href="{{url('assets1/assets/owlcarousel/assets/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{url('assets1/assets/owlcarousel/assets/owl.theme.default.min.css')}}">
    ...
    <!-- javascript -->
    <script src="{{url('assets1/assets/vendors/jquery.min.js')}}"></script>
    <script src="{{url('assets1/assets/owlcarousel/owl.carousel.js')}}"></script>    
...
<div class="slide-out">
    ...
    <ul class="side_navigation">
      ...
      @if(session('studenteamroleId')!=0)
      <li><a href="{{url('manufacturePage/')}}/{{base64_encode($studentid.'.'.$schoolid)}}">Apply for Manufacturing</a></li>

      <li><a href="{{url('add_sponsership')}}/{{base64_encode($studentid.'_'.$schoolid)}}">Add Sponsorship</a></li>
      @endif
...
<div class="footer">
  <div class="container">
    ...
    <div class="copyright">&copy; Time of Sports 2020 | All Right Reserved</div>
  </div>
</div>
