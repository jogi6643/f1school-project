...
<body>
            ...
            <div class="navbar-header">
               <a class="navbar-brand" href="#/">
                  <div class="brand-logo text-light">
                    <img class="img-fluid" src="{{url('assets/image/icon.png')}}" alt="App Logo">
         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
				  ...
				  @if(in_array(1,array_keys(session('data'))))
                 <li class=" ">
                 ...
                 @endif
				   @if(in_array(2,array_keys(session('data'))))

                  <li class=" ">
                     <a href="{{url('location')}}" title="Widgets">
				  ...
				  @endif
				  @if(in_array(15,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/school')}}" title="Widgets">
				  ...
				  @endif
				  @if(in_array(3,array_keys(session('data'))))
                   <li class=" ">
				  ...
				  @endif
				    @if(in_array(5,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/course')}}" title="Widgets">
				  ...
				  @endif
				   @if(in_array(6,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/coursename')}}" title="Widgets">
				  ...
				  @endif
				   @if(in_array(7,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/membership')}}" title="Widgets">
				  ...
				  @endif 
				  @if(in_array(8,array_keys(session('data'))))
                   <li class=" ">
                     <a href="{{url('/atrainer')}}" title="Widgets">
				 ...
				 @endif
				  @if(in_array(16,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/trainerassigned')}}" title="Widgets">
                        
                        <em class="icon-magic-wand"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Trainer Assigned</span>
                     </a>
                  </li>
                  
                   @endif
				    @if(in_array(9,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/manufacturingapplication_ad')}}" title="Widgets">
				  ...
				  @endif
				   @if(in_array(10,array_keys(session('data'))))
                  <li class=" ">
                     <a href="{{url('/orderListshowbyAdmin')}}" title="Widgets">
				  ...
				  @endif
				   @if(in_array(11,array_keys(session('data'))))
				  <li class="">
                     <a href="{{url('/listplan')}}" title="Widgets">
				  ...
				  @endif
				   @if(in_array(12,array_keys(session('data'))))
                   <li class=" ">
                     <a href="{{url('/viewpriceassignschool')}}" title="Widgets">
                   ...
                   @endif
				    @if(in_array(13,array_keys(session('data'))))
				    <li class=" ">
                     <a href="{{url('/sponsershipadmin')}}" title="Widgets">
                        <em class="icon-menu"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Sponsorship</span>
                     </a>
                  </li>
				  @endif
				   @if(in_array(14,array_keys(session('data'))))
                    
                  <li class=" ">
                     <a href="{{url('/teamviewadd')}}" title="Widgets">
   ...
   <script src="{{asset('public/admin/js/app.js')}}"></script>
        ...
        <script type="text/javascript" src={{url("resources/assets/js/prettify.min.js")}}></script>
 
    <script type="text/javascript" src='{{url("resources/assets/js/bootstrap-multiselect.js")}}'></script>
