...
<body>
      ...
      <header class="topnavbar-wrapper">
         ...
         <nav class="navbar topnavbar">
            ...
            <ul class="navbar-nav mr-auto flex-row">
               ...
               <!-- END lock screen-->
               <form id="logout-form" action="{{ url('sclogout') }}" method="POST" style="">
                                        @csrf
                                    </form>
            </ul>
            <!-- END Left navbar-->
            ...
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                  ...
                  <li class=" ">
                   ...
                   <li class=" ">
                     <a href="{{url('edit-profile-school')}}" title="Edit School">
                        <em class="icon-magic-wand"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Edit School</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="{{url('studentviewS')}}" title="List Student">
                        
                        <em class="icon-magic-wand"></em>
                        <span data-localize="sidebar.nav.WIDGETS">List Student</span>
                     </a>
                  </li>
                  
                  <li class=" ">
                     <a href="{{url('/vTeamS')}}" title="View Team">
               ...
               <li class=" ">
                     ...
                     <a href="{{url('/academic-year-school-wise')}}/{{$year}}" title="Academic Year">
   ...
   <script src="{{asset('admin/js/app.js')}}"></script>
        ...
        <script type="text/javascript" src={{asset("assets/js/prettify.min.js")}}></script>
