      ...
      <header class="topnavbar-wrapper">
         ...
         <nav class="navbar topnavbar">
            ...
            <ul class="navbar-nav mr-auto flex-row">
               ...
               <!-- END lock screen-->
               <form id="logout-form" action="{{ url('trlogout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
            </ul>
            <!-- END Left navbar-->
         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                  ...
                  <li class=" ">
                     <a href="{{url('edit-profile-trainer')}}" title="edit">
                  ...
                  <li class=" ">
                     <a href="{{url('assignedschool')}}" title="Widgets">
                        
                        <em class="icon-magic-wand"></em>
                        <span data-localize="sidebar.nav.WIDGETS">School List</span>
                     </a>
                  </li>
                  <li class=" ">
                     <?php $year = date('Y')."-".(date('Y')+1);?>
                     <a href="{{url('/academic-year-trainer-wise')}}/{{$year}}" title="Academic Year">
