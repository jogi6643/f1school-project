...
<!-- <a href="http://f1inschoolsindia.timeofsports.com/manufacturingapplication" title="Widgets">
            ...
            <div class="navbar-header">
               <a class="navbar-brand" href="#/">
                  <div class="brand-logo text-light">
                    <img class="img-fluid" src="{{asset('public/assets/image/icon.png')}}" alt="App Logo">
            ...
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                  ...
                  <li class=" ">
                   ...
                   <li  class=" ">
                     <a href="{{url('coadmin')}}" title="Coadmin">
                        
                        <em class="icon-menu"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Coadmin</span>
                     </a>
                  </li>
                   <li  class=" ">
                     <a href="{{url('listrole')}}" title="List Role">
                        
                        <em class="icon-menu"></em>
                        <span data-localize="sidebar.nav.WIDGETS">List Role</span>
                     </a>
                  </li>

                  <li class=" ">
                     <a href="{{url('location')}}" title="Location Master">
                        
                        <em class="icon-menu"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Location Master</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="{{url('/school')}}" title="School Master">
                        
                        <em class="icon-magic-wand"></em>
                        <span data-localize="sidebar.nav.WIDGETS">School Master</span>
                     </a>
                  </li>
                   <li class=" ">
                     <a href="{{url('competition')}} " title="Competition">
                        
                        <em class="icon-grid"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Competition Master</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="{{url('/course')}}" title="Activity Master">
                        
                        <em class="icon-list"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Activity Master</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="{{url('/coursename')}}" title="Course Name">
                        
                        <em class="icon-chemistry"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Course Name</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="{{url('/membership')}}" title="Plan Master">
                        
                        <em class="icon-graph"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Plan Master</span>
                     </a>
                  </li>
                   <li class=" ">
                     <a href="{{url('/atrainer')}}" title="Trainer Master">
                        
                        <em class="icon-magic-wand"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Trainer Master</span>
                     </a>
                  </li>
                 
                  
                  <!-- manufacturapplication_ad -->
                  <li class=" ">
                     <a href="{{url('/manufacturing-applications')}}" title="Manufacturing Application">
                        
                        <em class="icon-notebook"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Manufacturing Application</span>
                     </a>
                  </li>
                  <li class=" ">
                     <!-- orderListshowbyAdmin -->
                     <a href="{{url('/order-list')}}" title="Order List">
                        
                        <em class="icon-notebook"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Order List</span>
                     </a>
                  </li>
				  <li class=" ">
                     <a href="{{url('/listplan')}}" title="Price Master">
                        
                        <em class="icon-notebook"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Price Master</span>
                     </a>
                  </li>
                   <li class=" ">
                     <a href="{{url('/assignpicemaster')}}" title="Assign Price Master">
                        
                        <em class="icon-notebook"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Assign Price Master</span>
                     </a>
                  </li>

				    <li class=" ">
                     <a href="{{url('/sponsershipadmin')}}" title="Sponsorship">
                        <em class="icon-menu"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Sponsorship</span>
                     </a>
                  </li>
                    
                  <li class=" ">
                     <a href="{{url('/teamviewadd')}}" title="View Team">
                        
                        <em class="icon-notebook"></em>
                        <span data-localize="sidebar.nav.WIDGETS">View Team</span>
                     </a>
                  </li>

                  <li class=" ">
                     <?php $year = date('Y')."-".(date('Y')+1);?>
                     <a href="{{url('/academic-year-wise-info')}}/{{$year}}" title="Academic Year">
                        
                        <em class="icon-menu"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Academic Year</span>
                     </a>
                  </li>
                 <!-- <li class=" ">
                  ...
                  <div class="tab-pane fade" id="app-chat" role="tabpanel">
                     ...
                     <div class="list-group">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                           <div class="media">
                              <img class="align-self-center mr-3 rounded-circle thumb48" src="{{asset('admin/img/user/05.jpg')}}" alt="Image">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                           <div class="media">
                              <img class="align-self-center mr-3 rounded-circle thumb48" src="{{asset('admin/img/user/06.jpg')}}" alt="Image">
                              <div class="media-body text-truncate">
                                 <a href="#">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                           <div class="media">
                              <img class="align-self-center mr-3 rounded-circle thumb48" src="{{asset('admin/img/user/07.jpg')}}" alt="Image">
                              <div class="media-body text-truncate">
                                 <a href="#">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                           <div class="media">
                              <img class="align-self-center mr-3 rounded-circle thumb48" src="{{asset('admin/img/user/08.jpg')}}" alt="Image">
                              <div class="media-body text-truncate">
                                 <a href="#">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                           <div class="media">
                              <img class="align-self-center mr-3 rounded-circle thumb48" src="{{asset('admin/img/user/09.jpg')}}" alt="Image">
                              <div class="media-body text-truncate">
                                 <a href="#">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                           <div class="media">
                              <img class="align-self-center mr-3 rounded-circle thumb48" src="{{asset('admin/img/user/10.jpg')}}" alt="Image">
                              <div class="media-body text-truncate">
                                 <a href="#">
