	...
	public function Academic_year_school()
{
   ...
   $trainer = Trainer::where('email',$email)->first()->id;
...
// dd($eq);
  ...
  return view('Trainer.AcademicyearTrainer.Academic_Year_Assign_Trainer',compact('team','eq','eq1','sctr','ac_year'));
    ...
    public function check_data_according_to_year_wise_trainer(Request $req)
  {
    ...
    $data->save();
     ...
     Session::flash('success', "Updated Academic Year");
      return redirect('academic-year-trainer-wise/'.$req->academicyear);
  }
