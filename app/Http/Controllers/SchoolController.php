...
/*End Assign Plan for Student*/
    ...
    public function studentlistformail(Request $req)
    {
	   ...
	   $apikey = "YXPskaQxMk6oxtQcQbPo2Q";
            ...
            $msg = "Dear ".strtoupper($student->name).",\r\n".$schoolname." Welcomes you to Join STEM Club powered by F1 in Schools India.\r\nNow learning will be fun.\r\nSignup: timeofsports.com/techclub";
   ...
   // }
    ...
    public function cronstratstudent()
    {
        ...
        //         Signup: timeofsports.com/techclub";
            ...
            // $msg = "Dear ".$student->name.",Explore STEM Learning Platform powered by F1 in Schools India. Now Learning will be Fun! Signup:".url('studentlogin');
